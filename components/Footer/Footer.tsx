...
export default function Footer() {
    return (
        ...
        <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col ">
          ...
          <img className="h-20 cursor-pointer" src={logo} />
          </a>
          </Link>
          <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2020 Hubert Marzecki —
            <a href="https://www.instagram.com/jamarzec/" className="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">@jamarzec</a>
          </p>
