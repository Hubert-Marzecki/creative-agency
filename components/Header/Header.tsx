  ...
  const router = useRouter()
    ...
    return (
        ...
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          ...
          <a className="cursor-pointer flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0 mt-0">
          ...
          <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center ">
            ...
            <a className={
              router.pathname === "/" ? 
              "mr-5 hover:text-gray-300 cursor-pointer text-gray-100":
              "mr-5 hover:text-gray-300 cursor-pointer" 
              }>Home</a>
            </Link>
            <Link href="/projekty">
            <a className={
