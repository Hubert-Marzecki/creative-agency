...
<section class="text-gray-300 body-font">
  <div class="container px-5 pb-24 pt-10 mx-auto">
    <div class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
      ...
      <h2 class="text-gray-100 font-medium title-font tracking-wider text-sm">HOLDEN CAULFIELD</h2>
      <p class="text-gray-700 leading-relaxed">Senior Product Designer</p>
    </div>
  </div>
</section>
